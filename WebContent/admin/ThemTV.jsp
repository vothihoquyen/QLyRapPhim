	...
	<div class="container">
		...
		<div class="">
		  ...
		  <div class="form-center">
		          <form class="form-horizontal" action="<%=request.getContextPath()%>/addThanhVien" name="addcustomer" method="post" id="addcustomerID">
		          	  	 ...
		          	  	 <div class="form-group">
				              <label class="control-label col-sm-2" for=""><span class=""></span> Tên Thành Viên:</label>
					               <div class="col-sm-10">
					               		<div class="row">
					               			<div class="col-sm-8">
						             			 <input type="text" class=" form-control "  value="" name="tenTV" placeholder="Tên khách hàng" id="name">
					               			</div>
					               			<div class="col-sm-2">
												<p id="icon-name"></p>
					               			</div>
		          	  	...
		          	  	<div class="form-group">
				              <label class="control-label col-sm-2" for=""><span class=""></span> Tuổi:</label>
					               <div class="col-sm-10">
										...
										<div class="row">
											<p style="color: red" id="error-tyoi"></p>	
										</div>
					           		</div>
		          	  	</div>  
		          	  	<div class="form-group">
