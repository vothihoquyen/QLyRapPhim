...
(function(h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": KĂ­ch hoáº¡t tĂ­nh nÄƒng sáº¯p xáº¿p tÄƒng dáº§n",
                sSortDescending: ": KĂ­ch hoáº¡t tĂ­nh nÄƒng sáº¯p xáº¿p giáº£m dáº§n"
            },
            oPaginate: {
                sFirst: "Äáº¿n",
                sLast: "Vá»",
                sNext: "Tiáº¿p theo",
                sPrevious: "Trá»Ÿ láº¡i"
            },
            sEmptyTable: "KhĂ´ng cĂ³ dá»¯ liá»‡u thĂ­ch há»£p trong báº£ng",
            sInfo: "Hiá»ƒn thá»‹ _START_ tá»« _END_ cá»§a _TOTAL_ pháº§n tá»­",
            sInfoEmpty: "Hiá»ƒn thá»‹ 0 tá»« 0 cá»§a 0 pháº§n tá»­",
            sInfoFiltered: "(ÄĂ£ lá»c tá»« _MAX_ trĂªn tá»•ng sá»‘ pháº§n tá»­)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Hiá»ƒn thá»‹ _MENU_ pháº§n tá»­",
            sLoadingRecords: "Äang táº£i...",
            sProcessing: "Xá»­ lĂ½...",
            sSearch: "TĂ¬m kiáº¿m:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "KhĂ´ng tĂ¬m tháº¥y dá»¯ liá»‡u"
        },
